...
public class Sound {
    ...
    public Sound() {
        ...
        soundURL[13]=getClass().getResource("/sounds/blocked.wav");
        soundURL[14]=getClass().getResource("/sounds/parry.wav");
        soundURL[15]=getClass().getResource("/sounds/speak.wav");
        soundURL[16]=getClass().getResource("/sounds/Merchant.wav");
        soundURL[17]=getClass().getResource("/sounds/Dungeon.wav");
        soundURL[18]=getClass().getResource("/sounds/dooropen.wav");
        soundURL[19]=getClass().getResource("/sounds/FinalBattle.wav");
    }
